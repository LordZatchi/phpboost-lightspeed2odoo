...
class LightspeedtoOdooSetup extends DefaultModuleSetup
{
    ...
    private function create_mappings_table()
    {
        $fields = array(
            ...
            'mapping_data' => array('type' => 'text', 'length' => 65000, 'notnull' => 1),
    ...
    private function create_uploads_table()
    {
        $fields = array(
            ...
            'status' => array('type' => 'string', 'length' => 50, 'notnull' => 1, 'default' => 'pending'),
            ...
            'errors_log' => array('type' => 'text', 'length' => 65000),
        ...
        $options = array(
            ...
            'indexes' => array(
                ...
                'upload_date' => array('type' => 'key', 'fields' => 'upload_date')
            )
        );
    ...
    private function insert_data()
    {
        PersistenceContext::get_querier()->insert(self::$lightspeedto_odoo_mappings_table, array(
            'name' => 'Mapping Lightspeed par defaut',
            'description' => 'Mapping par defaut pour les exports Lightspeed Serie K',
